...
INSERT INTO T_ORDER(id, customer_id, expiry_datetime, status, total_amount, currency_code, payment_method, payment_id)
  VALUES(200, 3, '2030-10-11', 'CONFIRMED', '6000', 'XAF', 'ONLINE', 123);
