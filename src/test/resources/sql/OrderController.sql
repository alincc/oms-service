...
INSERT INTO T_ORDER(id, site_id, customer_id, language_code, expiry_datetime, status, total_amount, currency_code, payment_method, payment_id, first_name, last_name, email, device_uid)
  VALUES(200, 1, 3, 'fr', '2030-10-11', 'CONFIRMED', '6000', 'XAF', 'ONLINE', 123, 'Ray', 'Sponsible', 'ray@gmail.com', '1234-1234');
